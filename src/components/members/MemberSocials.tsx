...
function SocialIcon({ type }: { type: string }) {
  ...
  switch (type) {
    ...
    case "website":
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-label="Website">
    ...
    case "ctftime":
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-label="CTFtime">
    ...
    case "email":
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-label="Email">
    ...
    default:
      return <span className="text-[10px] tracking-[0.12em] uppercase">{type.toUpperCase()}</span>;
  }
}
      ...
      {links.map(([type, url]) => {
        ...
        return (
          <ExternalLink
            key={type}
            href={href}
            className="flex items-center justify-center w-8 h-8 rounded border transition-colors duration-150 hover:border-[var(--accent-red)] hover:text-[var(--accent-red)]"
            style={{
              color: "var(--muted)",
